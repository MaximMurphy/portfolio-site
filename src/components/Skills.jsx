...
export default function Skills() {
  return (
    <section id="about" className="pt-12 pb-12 px-10 lg:px-24 tracking-wider">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 text-center justify-items-center text-offwhite-400 text-base lg:text-xl tracking-wider py-8 lg:py-10 px-4 lg:px-2 gap-10 lg:gap-12">
        ...
        <div className="lg:flex flex-row gap-1 hidden lg:gap-2 w-36 lg:w-48 justify-center bg-blue-950 p-8">
          <p>Git</p>
