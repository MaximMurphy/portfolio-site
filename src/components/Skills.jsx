...
export default function Skills() {
  return (
    <section className="flex flex-col text-center lg:text-start text-softblue-400 text-2xl tracking-wider p-12 py-24 bg-blue-950 gap-12">
      <h1 className="text-white underline font-semibold">Skills</h1>
      <div className="flex flex-col justify-between font-medium px-12 gap-16 lg:px-24 lg:flex-row">
