...
export default function Socials() {
  return (
    <section className="flex flex-col px-10 lg:px-24 gap-12 lg:gap-24 font-base tracking-wider pb-4">
      <div>
        <p className="w-full text-cyan-800 text-2xl lg:text-3xl text-justify leading-8 lg:leading-10">
