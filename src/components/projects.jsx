...
const ProjectCard = ({ project }) => (
  <div className="h-[34rem] lg:h-[36rem] w-[320px] lg:w-96 flex flex-col items-start bg-offwhite-600 border-2 border-offwhite-800 text-cyan-950 rounded-xl p-8 gap-8">
